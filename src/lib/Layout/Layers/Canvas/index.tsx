...
import { CanvasState, LayerRenderingBoxesState } from '../../recoilState';
...
const LayersCanvas = (props: any) => {
	...
	return (
		<div className='w-full h-[calc(100vh-32px)] flex justify-center items-center'>
			{/** Canvas 객체 */}
			<div
				className='wrapper-box shadow-xl shadow-black/5 rounded-md border border-pg-gray-medium max-w-full max-h-[calc(100vh-32px)] box-border flex flex-wrap content-start bg-white relative'
				style={{
